...
-- INSERT INTO Orders_DIMENSIONAL_DW.dbo.DimTerritories_SCD4_History
...
-- FROM
--     Orders_DIMENSIONAL_DW.dbo.Territories AS T
--     LEFT JOIN Orders_DIMENSIONAL_DW.dbo.DimTerritories_SCD4 AS D ON T.TerritoryID = D.TerritoryID
-- WHERE
...
--     RegionID = T.RegionID
-- FROM
--     Orders_DIMENSIONAL_DW.dbo.DimTerritories_SCD4 AS D
--     INNER JOIN Orders_DIMENSIONAL_DW.dbo.Territories AS T ON D.TerritoryID = T.TerritoryID
--     INNER JOIN Orders_DIMENSIONAL_DW.dbo.DimTerritories_SCD4_History AS H ON H.TerritoryDescription = T.TerritoryDescription
-- WHERE
